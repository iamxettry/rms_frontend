...
const Navbar = () => {
  ...
  return (
    <>
      <nav className=" bg-green-50 py-1 dark:bg-black sticky top-0 z-50   border-b drop-shadow-md dark:border-b-slate-300 dark:border-opacity-30 ">
              ...
              {Navlink.map((link, index) =>{ 
                ...
                return(
                  <Link
                    ...
                    className={
                      isActive ?"bg-green-700 rounded text-white py-2 pl-3 md:hover:text-orange-700 md:text-orange-500 md:bg-transparent md:p-0  font-bold":"font-bold py-2 pl-3 text-gray-700 border-b border-b-gray-100 rounded hover:bg-green-400  md:p-0 md:bg-transparent md:hover:bg-transparent md:border-0 hover:text-white md:hover:text-black/90 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-green-400 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                    }
